...
describe Google::Maps::Static::Map do
  ...
  it "should be able to encode the url for practical use" do
    map = Google::Maps::Static::Map.new
    map[:center] = "Williamsburg,Brooklyn,NY"
    map[:zoom] = 13
    map << Google::Maps::Static::Markers.new( '11211', '11206', '11222', :color => :blue, :label => 'S' )
    
    map.url.urlencode.should orderlessly_match("http://maps.google.com/maps/api/staticmap?center=Williamsburg,Brooklyn,NY&zoom=13&size=400x400&markers=color:blue%7Clabel:S%7C11211%7C11206%7C11222&sensor=false")
  end
